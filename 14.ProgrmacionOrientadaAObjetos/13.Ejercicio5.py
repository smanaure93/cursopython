'''
Crear un programa con tres clases Universidad, con atributos nombre (Donde se almacena el nombre
de la Universidad).
Otra llamada Carerra, con los atributos especialidad (En donde me guarda la especialidad de
un estudiante).
...
class Estudiante(Universidad, Carerra):
    def datos(self, nombre, edad):
        ...
        print("Mi nombre es {}, tengo {} años, mi especialidad es {}. Estudio en la Universidad {}".format(
            self.nombre, self.edad, self.especialidad, self.Nombre))
